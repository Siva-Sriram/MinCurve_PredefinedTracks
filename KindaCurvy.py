...
def main():
    ...
    # Smooth the centerline using Bezier curves
    ...
    centerline_curvature_smooth = np.sum(calculate_curvature(x_smooth_centerline, y_smooth_centerline))
    print("Curvature of the smoothed centerline:", centerline_curvature_smooth)
